...
export default function AnomaliesDetectPage() {
  ...
  const onChartClick = (params: any) => {
    ...
    for (let idx = 0; idx < series.length; idx++) {
      if (series[idx] && series[idx].data[dataIndex].length > 0) {
        totalCnt = totalCnt + Number(series[idx].data[dataIndex][1]);
      }
    }
    ...
    getAlertTable(gridDate, 1, newPageSize);
  };
  ...
  const getAlertTable = async (
    ...
    try {
      ...
      console.log('dtYmd >>>>>>>> ', dtYmd);
      console.log('dtHour >>>>>>> ', dtHour);
          ...
          .then(function (res) {
            ...
            if (resCode === 200) {
              ...
              if (dataVal && dataVal != null) {
                ...
                const fileNm = DOWNLOAD_FILENM_ALERT.concat('_')
                  .concat(fileDownDt)
                ...
                const wscolVal = wscols.with(2, { width: 50 });
                ws['!cols'] = wscolVal;
