...
import { RES_CHART_TITLE_DISK_USAGE } from "@/data/monitor/resources";
...
const DiskUsage = (chartProps: ChartProps) => {
  return (
    <React.Fragment>
      <ReactEChart
        dataSourceType={dataSourceType.DISK_USAGE}
        widthVal={chartProps.widthVal}
        heightVal={chartProps.heightVal}
        chartOptions={EChartOption({
          chartType: "line",
          chartTitle: RES_CHART_TITLE_DISK_USAGE,
          colors: GetChartColors(dataSourceType.DISK_USAGE),
